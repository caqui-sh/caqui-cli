# Audit Dimension Specification *(Atomic & Terminal / Non-Divisible)*: Semantic Uniqueness - Substance (semantic_uniqueness.dimension.md)

This specification defines the rules for the **Semantic Uniqueness** dimension. It audits the target asset for unnecessary repetition and overlapping information, ensuring each conceptual element is represented exactly once, answering: *Is the target asset free from unnecessary repetition or overlap?*
