...
* **Semantic Fidelity (Meaning Accuracy)**:
  ...
  - **Mutual Exclusive Distinction**: It checks if the conceptual model of the target asset is correct, completely blind to whether individual raw data units are perfectly exact at the ground level, and blind to how concisely that model is written.
