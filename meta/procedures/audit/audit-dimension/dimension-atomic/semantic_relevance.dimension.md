...
* **Semantic Relevance (Targeted Value)**:
  - **Constraint**: Every piece of included information within the target asset must be strictly necessary and useful for achieving the immediate objective function.
  - **Audit Focus**: Identifies and flags superfluous or off-target information.
  - **Mutual Exclusive Distinction**: Evaluates utility. The target asset can be 100% structurally compliant, factually accurate, and logically sound, but completely useless to the task at hand.
