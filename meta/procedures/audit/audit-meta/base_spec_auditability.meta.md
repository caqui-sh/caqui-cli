...
* **Semantic Substance (Content)**:
  ...
  - *Audit Translation*: Provides the ground truth for auditing the [**Data Validity**](audit-dimension/dimension-atomic/data_validity.dimension.md), [**Semantic Relevance**](audit-dimension/dimension-atomic/semantic_relevance.dimension.md), [**Semantic Fidelity**](audit-dimension/dimension-atomic/semantic_fidelity.dimension.md), [**Semantic Veracity**](audit-dimension/dimension-atomic/semantic_veracity.dimension.md), and [**Semantic Consistency**](audit-dimension/dimension-atomic/semantic_consistency.dimension.md) dimensions.
