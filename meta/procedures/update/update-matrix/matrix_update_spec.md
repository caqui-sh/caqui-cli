...
[
  {
    ...
    "existingTestStepId": "<6_glyph_unique_test_step_identifier>"
  }
]
```
...
| `existingTestStepId` | String | No | `^[a-z0-9]{6}$` | Maps a modified use case to a preexisting E2E test step by its immutable 6-glyph unique identifier. Mandatory for modified boundary interfaces; prohibited for non-modified/new scenarios. |
